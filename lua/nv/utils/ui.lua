...
--
-- This module can be loaded with `local ui = require("nv.utils.ui")`
--
-- @module nv.utils.ui
-- @see nv.utils
-- @copyright 2022
...
local function ui_notify(silent, ...) return not silent and require("nv.utils").notify(...) end
...
function M.toggle_notifications(silent)
  ...
  ui_notify(silent, string.format("Notifications %s", bool2str(vim.g.notifications_enabled)))
end
...
function M.toggle_diagnostics(silent)
  ...
  vim.diagnostic.config(require("nv.utils.lsp").diagnostics[vim.g.diagnostics_mode])
...
function M.toggle_buffer_semantic_tokens(bufnr, silent)
  ...
  ui_notify(not toggled or silent,
...
function M.toggle_url_match(silent)
  ...
  require("nv.utils").set_url_match()
