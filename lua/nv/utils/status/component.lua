...
--
-- This module can be loaded with `local component = require "nv.utils.status.component"`
--
-- @module nv.utils.status.component
-- @copyright 2023
...
local hl = require("nv.utils.status.hl")
local init = require("nv.utils.status.init")
local provider = require("nv.utils.status.provider")
local status_utils = require("nv.utils.status.utils")

local utils = require("nv.utils")
local buffer_utils = require("nv.utils.buffer")
...
-- @usage local heirline_component = require("nv.utils.status").component.fill()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("nv.utils.status").component.file_info()
...
---@param opts? table options for configuring file_icon, filename, filetype, file_modified, file_read_only, and the overall padding
---@return table # The Heirline component table
-- @usage local heirline_component = require("nv.utils.status").component.tabline_file_info()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("nv.utils.status").component.nav()
function M.nav(opts)
  opts = extend_tbl({
    ruler = {},
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("nv.utils.status").component.cmd_info()
function M.cmd_info(opts)
  opts = extend_tbl({
    ...
    surround = {
      ...
      color = "cmd_info_bg",
      condition = function()
        return condition.is_hlsearch() or condition.is_macro_recording() or
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("nv.utils.status").component.mode { mode_text = true }
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("nv.utils.status").component.breadcumbs()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("nv.utils.status").component.separated_path()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("nv.utils.status").component.git_branch()
    ...
    on_click = {
      ...
      callback = function()
        if is_available("telescope.nvim") then
          vim.defer_fn(function() require("telescope.builtin").git_branches() end,
            100)
        end
      end,
    },
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("nv.utils.status").component.git_diff()
function M.git_diff(opts)
  opts = extend_tbl({
    ...
    on_click = {
      name = "heirline_git",
      callback = function()
        if is_available("telescope.nvim") then vim.defer_fn(function() require("telescope.builtin").git_status() end, 100) end
      end,
    },
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("nv.utils.status").component.diagnostics()
function M.diagnostics(opts)
  opts = extend_tbl({
    ...
    on_click = {
      ...
      callback = function()
        if is_available("telescope.nvim") then
          vim.defer_fn(function() require("telescope.builtin").diagnostics() end,
            100)
        end
      end,
    },
...
---@param opts? table options for configuring diagnostic providers and the overall padding
---@return table # The Heirline component table
-- @usage local heirline_component = require("nv.utils.status").component.treesitter()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("nv.utils.status").component.lsp()
function M.lsp(opts)
  opts = extend_tbl({
    lsp_progress = {
      str = "",
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("nv.utils.status").component.foldcolumn()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("nv.utils.status").component.numbercolumn()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("nv.utils.status").component.signcolumn()
    ...
    on_click = {
      ...
      callback = function(...)
        ...
        if args.sign and args.sign.name and env.sign_handlers[args.sign.name] then
          env.sign_handlers[args.sign.name](
            args)
        end
      end,
    },
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("nv.utils.status").components.builder({ { provider = "file_icon", opts = { padding = { right = 1 } } }, { provider = "filename" } })
function M.builder(opts)
  ...
  return opts.surround and
      status_utils.surround(opts.surround.separator, opts.surround.color, children, opts.surround.condition) or children
end
