...
--
-- This module can be loaded with `local base_heirline = require "nv.utils.status.heirline"`
--
-- @module nv.utils.status.heirline
-- @copyright 2023
...
M.make_buflist = function(component)
  ...
  return require("heirline.utils").make_buflist(
    ...
    function() return vim.t.bufs or {} end, -- use bufs variable
