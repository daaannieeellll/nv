...
--
-- This module can be loaded with `local env = require "nv.utils.status.env"`
--
-- @module nv.utils.status.env
-- @copyright 2023
...
M.buf_matchers = {
  ...
  bufname = function(pattern_list, bufnr)
    return pattern_match(
      vim.fn.fnamemodify(vim.api.nvim_buf_get_name(bufnr or 0), ":t"), pattern_list)
  end,
}
