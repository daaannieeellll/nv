--- ### Bootstrap
--
-- This module simply sets up the global `nvim` module.
-- This is automatically loaded and should not be resourced, everything is accessible through the global `nvim` variable.
--
-- @module bootstrap
-- @copyright 2022
...
nv.install = { home = vim.fn.stdpath("config") }
...
nv.lsp = { skip_setup = {}, progress = {} }
--- the default colorscheme to apply on startup
nv.colorscheme = "oxocarbon"
...
local function load_module_file(module)
  ...
  local module_path = nv.install.home .. "/lua/" .. module:gsub("%.", "/") .. ".lua"
...
function nv.user_opts(module, default, extend)
