return {
  ...
  event = "BufEnter",
  opts = function()
    local status = require("nv.utils.status")
    return {
      opts = {
        disable_winbar_cb = function(args)
          return not require("nv.utils.buffer").is_valid(args.buf)
      ...
      tabline = { -- bufferline
        ...
        {                                                                       -- tab list
          ...
          { -- close button for current tab
            ...
            on_click = {
              callback = function() require("nv.utils.buffer").close_tab() end,
  ...
  config = function(_, opts)
    ...
    local C = require("nv.utils.status.env").fallback_colors
    local get_hlgroup = require("nv.utils").get_hlgroup
    local lualine_mode = require("nv.utils.status.hl").lualine_mode
