return {
  {
    ...
    opts = {
      override = {
        default_icon = { icon = require("nv.utils").get_icon("DefaultFile") },
        deb = { icon = "", name = "Deb" },
  ...
  },
  {
    ...
    init = function() require("nv.utils").load_plugin_with_func("nvim-notify", vim, "notify") end,
    opts = {
      render = "compact",
      stges = "fade",
      top_down = false,
  ...
  },
  {
    ...
    init = function() require("nv.utils").load_plugin_with_func("dressing.nvim", vim.ui, { "input", "select" }) end,
    opts = {
